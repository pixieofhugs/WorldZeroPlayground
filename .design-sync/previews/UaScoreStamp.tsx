...
export function Crowned() {
  return (
    <div style={wrap}>
      <UaScoreStamp praxis={makePraxisCard({ task_faction_slug: 'ua' })} />
    </div>
  )
}
...
export function CrownSuppressed() {
  return (
    <div style={wrap}>
      <UaScoreStamp praxis={makePraxisCard({ task_faction_slug: 'ua' })} showCrown={false} />
    </div>
  )
}
