// AlbescentSeal preview cells — the sticker an applied metatask leaves on a praxis.
...
import { AlbescentSeal } from 'worldzero-frontend'
...
export function Applied() {
  return (
    <div style={wrap}>
      <AlbescentSeal metatask={metataskFor('albescent')} />
    </div>
  )
}
...
export function LongCondition() {
  return (
    <div style={wrap}>
      <AlbescentSeal
        metatask={metataskFor('albescent', {
...
export function Removable() {
  return (
    <div style={wrap}>
      <AlbescentSeal metatask={metataskFor('albescent')} removable onRemove={noop} />
    </div>
  )
}
