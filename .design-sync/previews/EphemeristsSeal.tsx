// EphemeristsSeal preview cells — the sticker an applied metatask leaves on a praxis.
...
import { EphemeristsSeal } from 'worldzero-frontend'
...
export function Applied() {
  return (
    <div style={wrap}>
      <EphemeristsSeal metatask={metataskFor('ephemerists')} />
    </div>
  )
}
...
export function LongCondition() {
  return (
    <div style={wrap}>
      <EphemeristsSeal
        metatask={metataskFor('ephemerists', {
...
export function Removable() {
  return (
    <div style={wrap}>
      <EphemeristsSeal metatask={metataskFor('ephemerists')} removable onRemove={noop} />
    </div>
  )
}
