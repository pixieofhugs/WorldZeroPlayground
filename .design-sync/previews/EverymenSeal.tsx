// EverymenSeal preview cells — the sticker an applied metatask leaves on a praxis.
...
import { EverymenSeal } from 'worldzero-frontend'
...
export function Applied() {
  return (
    <div style={wrap}>
      <EverymenSeal metatask={metataskFor('everymen')} />
    </div>
  )
}
...
export function Removable() {
  return (
    <div style={wrap}>
      <EverymenSeal metatask={metataskFor('everymen')} removable onRemove={noop} />
    </div>
  )
}
