// SnideProposeTask — Snide's dress on the propose-task page (#2538): its own wall.
//
// The page dispatches on the faction the task is proposed FOR, so the slug
// passed is 'snide' — it is selectable in the picker, so its chip renders
...
import { SnideProposeTask } from 'worldzero-frontend'
import { proposeTaskState } from './_state'

export function Propose() {
  return <SnideProposeTask state={proposeTaskState('snide')} />
}
