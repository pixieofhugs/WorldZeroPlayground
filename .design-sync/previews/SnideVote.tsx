...
// Auth is mocked authed so the interactive stamps render. State comes from
...
export function Caster() {
  return (
    <div style={wrap}>
      <SnideVote praxisId={731} currentValue={3} />
    </div>
  )
}
...
export function Summary() {
  return (
    <div style={wrap}>
      <SnideVote praxisId={731} currentValue={4} points={39} totalVotes={9} />
    </div>
  )
}
...
export function TopRung() {
  return (
    <div style={wrap}>
      <SnideVote praxisId={731} currentValue={5} points={52} totalVotes={14} />
    </div>
  )
}
