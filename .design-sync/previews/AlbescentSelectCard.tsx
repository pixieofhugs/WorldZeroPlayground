// AlbescentSelectCard preview cells. AlbescentSelectCard is one faction's own tile in the
// character-creation picker — the vellum letter — the neutral default palette by design (#783), no faction hue.
...
import { AlbescentSelectCard } from 'worldzero-frontend'
...
export function StateAxis() {
  return (
    <div style={wrap}>
      <AlbescentSelectCard state="locked" members={12} onVisit={noop} />
      <AlbescentSelectCard state="eligible" members={12} onVisit={noop} />
      <AlbescentSelectCard state="member" members={12} onVisit={noop} />
    </div>
  )
}
...
export function NoMemberCount() {
  return (
    <div style={wrap}>
      <AlbescentSelectCard state="eligible" onVisit={noop} />
    </div>
  )
}
