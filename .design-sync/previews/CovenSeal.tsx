// CovenSeal preview cells — the sticker an applied metatask leaves on a praxis.
...
import { CovenSeal } from 'worldzero-frontend'
...
export function Applied() {
  return (
    <div style={wrap}>
      <CovenSeal metatask={metataskFor('coven')} />
    </div>
  )
}
...
export function Removable() {
  return (
    <div style={wrap}>
      <CovenSeal metatask={metataskFor('coven')} removable onRemove={noop} />
    </div>
  )
}
