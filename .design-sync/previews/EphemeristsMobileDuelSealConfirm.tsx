// EphemeristsMobileDuelSealConfirm preview cells — the dialog that seals a duel.
//
...
import { EphemeristsMobileDuelSealConfirm } from 'worldzero-frontend'
...
export function Submit() {
  return (
    <Stage>
      <EphemeristsMobileDuelSealConfirm
        duel={duelFor('ephemerists')}
        viewerCharacterId={7}
        taskPointValue={30}
        onConfirm={noop}
        onCancel={noop}
