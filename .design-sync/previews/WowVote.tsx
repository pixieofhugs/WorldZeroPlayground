...
// so the interactive hearts render. State comes from currentValue / points /
// totalVotes.
...
export function Caster() {
  return (
    <div style={wrap}>
      <WowVote praxisId={721} currentValue={3} />
    </div>
  )
}
...
export function Summary() {
  return (
    <div style={wrap}>
      <WowVote praxisId={721} currentValue={4} points={44} totalVotes={12} />
    </div>
  )
}
...
export function TopRung() {
  return (
    <div style={wrap}>
      <WowVote praxisId={721} currentValue={5} points={61} totalVotes={15} />
    </div>
  )
}
