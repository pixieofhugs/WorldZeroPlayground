// EverymenMobileDuelSealConfirm preview cells — the dialog that seals a duel.
//
...
import { EverymenMobileDuelSealConfirm } from 'worldzero-frontend'
...
export function Submit() {
  return (
    <Stage>
      <EverymenMobileDuelSealConfirm
        duel={duelFor('everymen')}
        viewerCharacterId={7}
        taskPointValue={30}
        onConfirm={noop}
        onCancel={noop}
