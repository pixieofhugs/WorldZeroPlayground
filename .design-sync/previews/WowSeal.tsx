// WowSeal preview cells — the sticker an applied metatask leaves on a praxis.
...
import { WowSeal } from 'worldzero-frontend'
...
export function Applied() {
  return (
    <div style={wrap}>
      <WowSeal metatask={metataskFor('wow')} />
    </div>
  )
}
...
export function Removable() {
  return (
    <div style={wrap}>
      <WowSeal metatask={metataskFor('wow')} removable onRemove={noop} />
    </div>
  )
}
