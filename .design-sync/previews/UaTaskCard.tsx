...
export function Default() {
  ...
  return (
    <div style={wrap}>
      <UaTaskCard task={task} basePoints={task.point_value} multiplier={1} inProgressCount={0} />
    </div>
  )
}
...
export function WithSignup() {
  ...
  return (
    <div style={wrap}>
      <UaTaskCard task={task} basePoints={task.point_value} multiplier={1} inProgressCount={0} onSignup={noop} />
    </div>
  )
}
