// SingularityMobileDuelSealConfirm preview cells — the dialog that seals a duel.
//
...
import { SingularityMobileDuelSealConfirm } from 'worldzero-frontend'
...
export function Submit() {
  return (
    <Stage>
      <SingularityMobileDuelSealConfirm
        duel={duelFor('singularity')}
        viewerCharacterId={7}
        taskPointValue={30}
        onConfirm={noop}
        onCancel={noop}
