import { SnideBackdrop } from "worldzero-frontend";

// SnideBackdrop renders a full-page `position:fixed; inset:0` atmosphere that would
  ...
  return (
    <div style={{ position: "relative", width: "100%", height: 300, overflow: "hidden", borderRadius: 8 }}>
      ...
      <div style={{ position: "relative", zIndex: 2, height: "100%", display: "flex", alignItems: "flex-end", padding: 16 }}>
        <span style={{ fontFamily: "\"Special Elite\", monospace", fontSize: 13, letterSpacing: "0.18em", textTransform: "uppercase", opacity: 0.85 }}>S.N.I.D.E.</span>
      </div>
    </div>
  );
}
