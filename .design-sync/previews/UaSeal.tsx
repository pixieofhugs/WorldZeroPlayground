// UaSeal preview cells — the sticker an applied metatask leaves on a praxis.
...
import { UaSeal } from 'worldzero-frontend'
...
export function Applied() {
  return (
    <div style={wrap}>
      <UaSeal metatask={metataskFor('ua')} />
    </div>
  )
}
...
export function Removable() {
  return (
    <div style={wrap}>
      <UaSeal metatask={metataskFor('ua')} removable onRemove={noop} />
    </div>
  )
}
