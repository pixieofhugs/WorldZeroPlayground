// SnideSeal preview cells — the sticker an applied metatask leaves on a praxis.
...
import { SnideSeal } from 'worldzero-frontend'
...
export function Applied() {
  return (
    <div style={wrap}>
      <SnideSeal metatask={metataskFor('snide')} />
    </div>
  )
}
...
export function Removable() {
  return (
    <div style={wrap}>
      <SnideSeal metatask={metataskFor('snide')} removable onRemove={noop} />
    </div>
  )
}
