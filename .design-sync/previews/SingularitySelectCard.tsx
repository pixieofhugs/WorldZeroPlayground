// SingularitySelectCard preview cells. SingularitySelectCard is one faction's own tile in the
// character-creation picker — the terminal printout — a monospaced readout under the process light.
...
import { SingularitySelectCard } from 'worldzero-frontend'
...
export function StateAxis() {
  return (
    <div style={wrap}>
      <SingularitySelectCard state="locked" members={301} onVisit={noop} />
      <SingularitySelectCard state="eligible" members={301} onVisit={noop} />
      <SingularitySelectCard state="member" members={301} onVisit={noop} />
    </div>
  )
}
...
export function NoMemberCount() {
  return (
    <div style={wrap}>
      <SingularitySelectCard state="eligible" onVisit={noop} />
    </div>
  )
}
