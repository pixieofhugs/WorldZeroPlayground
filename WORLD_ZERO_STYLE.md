...
So **the palette moves as one unit**, and the Valley plate is theme-INVARIANT at its night values, the way Singularity's terminal and S.N.I.D.E.'s photocopier black always were (§6). Light mode adopts the design's own dark drawing rather than a fresh tuning: a light band spliced onto a dark sheet is a palette nobody drew, and the night half was measured as a whole. Three things fall out that are the point rather than side effects:
