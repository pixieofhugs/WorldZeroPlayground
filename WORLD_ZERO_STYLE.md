...
**Reading a design kit: three things in a `.jsx` that are not part of the design.** Four waves of kits now agree on these, so treat them as translation rules rather than judgement calls.
