...
const UaEditCharacter = lazyArchetype(() => import('../pages/characterPaths/archetypes/UaEditCharacter'))
...
const UaProposeTask = lazyArchetype(() => import('../pages/proposeTask/archetypes/UaProposeTask'))
