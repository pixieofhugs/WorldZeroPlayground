 ...
 * the avatar that mounts it, and #899 the three repeating desktop surfaces (the
 * decree task card, the comment voice, the feed frame). Every OTHER surface
 ...
 * that mounts it, and #899's three repeating desktop surfaces: the decree
 * `taskCard`, the `comment` voice and the herald's-dispatch `feedFrame`. Every
 * other surface is still unclaimed, which is exactly the half-dressed state this
 * file guards.
 */
...
describe('wow is partly skinned: eleven surfaces claimed, the rest fall back', () => {
