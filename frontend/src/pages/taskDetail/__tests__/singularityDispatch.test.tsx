...
describe('mobile task-detail Singularity dispatch', () => {
  it('resolves singularity to the bespoke terminal mobile skin', () => {
    const skin = pickVariant(surfaceMap('mobileTaskDetail'), 'singularity', DefaultMobileTaskDetail)
  ...
  it('falls through to the Default mobile skin for other slugs', () => {
    for (const slug of ['__unregistered__', 'na', null]) {
      expect(pickVariant(surfaceMap('mobileTaskDetail'), slug, DefaultMobileTaskDetail)).toBe(DefaultMobileTaskDetail)
    }
  })
})
