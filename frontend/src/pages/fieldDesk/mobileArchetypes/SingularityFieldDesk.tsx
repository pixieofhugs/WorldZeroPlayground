...
// Three ROLES (#2675), declared as `--field-desk-*` on the void container below
...
// assumed.
const VOID = 'var(--field-desk-paper, var(--faction-singularity-card-bg))'
const PHOSPHOR = 'var(--field-desk-accent, var(--faction-singularity-card-accent))'
const SIGNAL = 'var(--field-desk-quiet, var(--faction-singularity-card-muted))'
...
export default function SingularityFieldDesk({ state }: { state: FieldDeskHomeState }) {
  ...
  return (
    <div
      ...
      className="page"
      style={{ ...factionRoleVars('singularity', 'field-desk'), display: 'flex', flexDirection: 'column', gap: 'var(--space-lg)', fontFamily: FONT, color: PHOSPHOR, background: VOID }}
    >
      {/* Prompt masthead */}
      <header>
