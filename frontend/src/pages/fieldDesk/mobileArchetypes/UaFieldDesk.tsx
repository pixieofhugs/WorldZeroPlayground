...
const SHEET = 'var(--leaf-mobile-field-desk-paper)'
const PANEL = 'var(--faction-ua-panel)'
const INK = 'var(--leaf-mobile-field-desk-ink)'
const MUTED = 'var(--leaf-mobile-field-desk-quiet)'
const ACCENT = 'var(--leaf-mobile-field-desk-accent)'
const RULE = 'var(--faction-ua-rule)'
const FILL = 'var(--leaf-mobile-field-desk-fill)'
const ON_FILL = 'var(--leaf-mobile-field-desk-on-fill)'
const DISPLAY = 'var(--leaf-mobile-field-desk-face)'
