    ...
    >
      <article
        style={{
          ...
          // paint below reads `var(--task-card-ink, <today's token>)`, so the
          ...
          borderRadius: "var(--task-card-radius, var(--faction-ua-card-radius))",
          color: "var(--task-card-ink, var(--faction-ua-card-text))",
          fontFamily: UA_TEXT,
        }}
      >
          ...
          <Link to={`/tasks/${task.id}`} data-card-link="" style={{ display: "block", textDecoration: "none", color: "inherit" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "var(--space-md)", marginBottom: "var(--space-md)" }}>
              ...
              <UaEnsoScore
                ...
                valueColor="var(--task-card-accent, var(--faction-ua-card-accent))"
              />
            </div>
            ...
            {task.description && (
              <p
                ...
                style={{
                  fontFamily: UA_TEXT,
                  lineHeight: 1.5,
                  color: "var(--task-card-quiet, var(--faction-ua-card-muted))",
