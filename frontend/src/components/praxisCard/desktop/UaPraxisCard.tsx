  ...
  return (
    <div
      style={{
        ...
        ...factionRoleVars("ua", "praxis-card"),
        position: "relative",
        overflow: "hidden",
        // The ensō salon sheet's shape, said once (#2361/#2403).
        borderRadius: "var(--praxis-card-radius, var(--faction-ua-card-radius))",
        background: "var(--faction-ua-card-parchment)",
        border: "2px solid var(--faction-ua-card-frame)",
        boxShadow:
          "0 14px 40px -22px color-mix(in srgb, var(--praxis-card-ink, var(--faction-ua-card-text)) 50%, transparent)",
        ...
        color: "var(--praxis-card-ink, var(--faction-ua-card-text))",
      }}
    >
      {/*
      ...
      <div style={{ position: "relative", padding: "var(--space-xl) var(--space-xl) var(--space-lg)" }}>
        ...
        <PraxisBody
          praxis={praxis}
          tint="var(--praxis-card-accent, var(--faction-ua-card-accent))"
          muted="var(--praxis-card-quiet, var(--faction-ua-card-muted))"
          paper="var(--praxis-card-paper, var(--faction-ua-card-bg))"
          titleStyle={{
            fontFamily: "var(--praxis-card-face, var(--faction-ua-card-font))",
            fontWeight: 600,
          ...
          fonts={{
            display: "var(--praxis-card-face, var(--faction-ua-card-font))",
