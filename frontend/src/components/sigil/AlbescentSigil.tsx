 ...
 * The mark then was a surveyor's cross-hair inked on the vellum reveal register
 * (always-light then; deleted outright by #2632), and a distinct emblem in a
 * distinct PALETTE, worn by an otherwise-hidden faction on surfaces an
 * unrevealed player reads, is a tell. The owner has ruled that this design supersedes that deletion. **Only
