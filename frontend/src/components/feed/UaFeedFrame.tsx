...
const ROW_SKIN: FeedRowSkin = {
  ink: { actor: 'var(--feed-frame-accent, var(--faction-ua-card-accent))' },
}
  ...
  return (
    <div
      style={{
        ...
        ...factionRoleVars('ua', 'feed-frame'),
        position: 'relative',
        overflow: 'hidden',
        background: 'var(--faction-ua-parchment)',
        color: 'var(--feed-frame-ink, var(--faction-ua-card-text))',
    ...
    >
      ...
      <div
        style={{
          ...
          gap: 'var(--space-sm)',
          minWidth: 0,
          color: 'var(--feed-frame-quiet, var(--faction-ua-card-muted))',
      ...
      >
        ...
        <span
          style={{
            ...
            color: 'var(--feed-frame-accent, var(--faction-ua-card-accent))',
            minWidth: 0,
            overflow: 'hidden',
        ...
        {tag && (
          ...
          <span
            style={{
              ...
              background: 'var(--feed-frame-accent, var(--faction-ua-card-accent))',
              borderRadius: 999,
